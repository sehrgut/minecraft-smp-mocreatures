...
public class ModelOgre1 extends ModelBiped
{
    ...
    public ModelOgre1()
    {
        ...
        bipedHead.addBox(-4F, -25F, -6F, 8, 8, 8, 0.0F);
        bipedHead.setPosition(0.0F, 0.0F, 0.0F);
        bipedEars = new ModelRenderer(41, 24);
        bipedEars.addBox(-4F, -31F, -3F, 8, 6, 1, 0.5F);
        bipedEars.setPosition(0.0F, 0.0F, 0.0F);
        bipedBody = new ModelRenderer(16, 16);
        bipedBody.addBox(-4F, -14F, -2F, 8, 12, 4, 3F);
        bipedBody.setPosition(0.0F, 0.0F, 0.0F);
        bipedRightArm = new ModelRenderer(0, 16);
        bipedRightArm.addBox(-7F, -2F, -2F, 1, 1, 1, 0.0F);
        bipedRightArm.setPosition(0.0F, 0.0F, 0.0F);
        bipedLeftArm = new ModelRenderer(0, 16);
        bipedLeftArm.mirror = true;
        bipedLeftArm.addBox(0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F);
        bipedLeftArm.setPosition(0.0F, 0.0F, 0.0F);
        bipedRightLeg = new ModelRenderer(40, 0);
        bipedRightLeg.addBox(-2F, -8F, -2F, 4, 18, 4, 1.5F);
        bipedRightLeg.setPosition(-4F, 12F, 0.0F);
        bipedLeftLeg = new ModelRenderer(40, 0);
        bipedLeftLeg.mirror = true;
        bipedLeftLeg.addBox(-2F, -8F, -2F, 4, 18, 4, 1.5F);
        bipedLeftLeg.setPosition(4F, 12F, 0.0F);
    }
