...
public class EntityDolphin extends EntityCustomWM
{
    ...
    {
        super(world);
        texture = "/moCreatures/textures/dolphin.png";
        setSize(1.5F, 0.8F);
    ...
    public void chooseType()
    {
        ...
        if(!typechosen)
        {
            ...
            if(typeint == 2)
            {
                texture = "/moCreatures/textures/dolphin2.png";
                dolphinspeed = 2.5D;
                temper = 100;
            } else
            if(typeint == 3)
            {
                texture = "/moCreatures/textures/dolphin3.png";
                dolphinspeed = 3.5D;
                temper = 150;
            } else
            if(typeint == 4)
            {
                texture = "/moCreatures/textures/dolphin4.png";
                dolphinspeed = 4.5D;
                temper = 200;
            } else
            if(typeint == 5)
            {
                texture = "/moCreatures/textures/dolphin5.png";
                dolphinspeed = 5.5D;
                temper = 250;
            } else
            if(typeint == 6)
            {
                texture = "/moCreatures/textures/dolphin6.png";
                dolphinspeed = 6.5D;
                temper = 300;
            }
        }
