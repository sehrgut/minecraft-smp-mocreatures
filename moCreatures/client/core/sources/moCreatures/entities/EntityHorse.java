...
public class EntityHorse extends EntityAnimal
{
    ...
    public EntityHorse(World world)
    {
        ...
        isjumping = false;
        tamed = false;
        texture = "/moCreatures/textures/horseb.png";
        typeint = 0;
    ...
    public void chooseType()
    {
        ...
        if(!typechosen)
        {
            ...
            if(typeint == 2)
            {
                ...
                temper = 200;
                HorseJump = 0.5D;
                texture = "/moCreatures/textures/horsebrownb.png";
                maxhealth = 30;
            } else
            if(typeint == 3)
            {
                ...
                texture = "/moCreatures/textures/horseblackb.png";
                maxhealth = 35;
            } else
            if(typeint == 4)
            {
                ...
                HorseJump = 0.59999999999999998D;
                temper = 400;
                texture = "/moCreatures/textures/horsegoldb.png";
                maxhealth = 40;
            } else
            if(typeint == 5)
            {
                HorseSpeed = 1.2D;
                temper = 500;
                texture = "/moCreatures/textures/horsewhiteb.png";
                maxhealth = 40;
            } else
            if(typeint == 6)
            {
                HorseSpeed = 0.90000000000000002D;
                temper = 600;
                texture = "/moCreatures/textures/horsepackb.png";
                maxhealth = 40;
            } else
            if(typeint == 7)
            {
                ...
                temper = 700;
                HorseJump = 0.59999999999999998D;
                texture = "/moCreatures/textures/horsenightb.png";
                maxhealth = 50;
                isImmuneToFire = true;
            } else
            if(typeint == 8)
            {
                HorseSpeed = 1.3D;
                temper = 800;
                texture = "/moCreatures/textures/horsebpb.png";
                maxhealth = 50;
                isImmuneToFire = true;
            }
        }
    ...
    public void moveEntityWithHeading(float f, float f1)
    {
        if(handleWaterMovement())
        {
            if(riddenByEntity != null)
            {
                ...
                if(EntityLivingHelper.getIsJumping(entityplayer) && !isjumping)
                {
                    motionY += 0.5D;
                    isjumping = true;
                }
        ...
        if(handleLavaMovement())
        {
            if(riddenByEntity != null)
            {
                ...
                if(EntityLivingHelper.getIsJumping(entityplayer1) && !isjumping)
                {
                    motionY += 0.5D;
                    isjumping = true;
                }
        ...
        } else
        {
            ...
            if(riddenByEntity != null && tamed)
            {
                ...
                if(EntityLivingHelper.getIsJumping(entityplayer2) && !isjumping)
                {
                    motionY += HorseJump;
                    isjumping = true;
                }
                if(EntityLivingHelper.getIsJumping(entityplayer2) && (typeint == 5 || typeint == 8))
                {
    ...
    public boolean interact(EntityPlayer entityplayer)
    {
        ...
        if(itemstack != null && tamed && itemstack.itemID == Block.chest.blockID && (typeint == 6 || typeint == 8))
        {
            if(chestedhorse)
            {
                return false;
