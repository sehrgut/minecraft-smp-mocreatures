...
import moCreatures.entities.EntityBoar;
import moCreatures.entities.EntityBunny;
import moCreatures.entities.EntityCaveOgre;
import moCreatures.entities.EntityDolphin;
import moCreatures.entities.EntityDuck;
import moCreatures.entities.EntityFireOgre;
import moCreatures.entities.EntityFlameWraith;
import moCreatures.entities.EntityFox;
import moCreatures.entities.EntityHorse;
import moCreatures.entities.EntityLionK;
import moCreatures.entities.EntityOgre;
import moCreatures.entities.EntityPolarBear;
import moCreatures.entities.EntityShark;
...
import moCreatures.entities.EntityWraith;
import moCreatures.items.HayStack;
import moCreatures.items.HorseSaddle;
import moCreatures.items.ItemSharkEgg;
import moCreatures.items.SugarLump;
import moCreatures.models.ModelBear1;
import moCreatures.models.ModelBear2;
import moCreatures.models.ModelBird;
import moCreatures.models.ModelBunny;
import moCreatures.models.ModelDolphin;
import moCreatures.models.ModelFox;
import moCreatures.models.ModelHorse1;
import moCreatures.models.ModelHorse2;
import moCreatures.models.ModelLionK1;
import moCreatures.models.ModelLionK2;
import moCreatures.models.ModelOgre1;
import moCreatures.models.ModelOgre2;
import moCreatures.models.ModelShark;
import moCreatures.models.ModelSharkEgg;
import moCreatures.models.ModelWereHuman;
import moCreatures.models.ModelWerewolf;
import moCreatures.models.ModelWildWolf1;
import moCreatures.models.ModelWildWolf2;
import moCreatures.models.ModelWraith;
import moCreatures.proxies.ItemProxy;
import moCreatures.renders.RenderBear;
import moCreatures.renders.RenderBird;
import moCreatures.renders.RenderBunny;
import moCreatures.renders.RenderCaveOgre;
import moCreatures.renders.RenderDolphin;
import moCreatures.renders.RenderFireOgre;
import moCreatures.renders.RenderFox;
import moCreatures.renders.RenderHorse;
import moCreatures.renders.RenderLionK;
import moCreatures.renders.RenderOgre;
import moCreatures.renders.RenderPolarBear;
import moCreatures.renders.RenderShark;
import moCreatures.renders.RenderSharkEgg;
import moCreatures.renders.RenderWerewolf;
import moCreatures.renders.RenderWildWolf;
...
public class mod_mocreatures extends BaseMod
{
	...
	public static Item horsesaddle = (new HorseSaddle(3772)).setIconIndex(ModLoader.addOverride("/gui/items.png", "/moCreatures/textures/horsesaddle.png")).setItemName("HorseSaddle");
	public static Item haystack = (new HayStack(3775)).setIconIndex(ModLoader.addOverride("/gui/items.png", "/moCreatures/textures/haystack.png")).setItemName("HayStack");
	public static Item sugarlump = (new SugarLump(3776)).setIconIndex(ModLoader.addOverride("/gui/items.png", "/moCreatures/textures/sugarlump.png")).setItemName("SugarLump");
	public static Item sharkteeth = (new ItemProxy(3774)).setIconIndex(ModLoader.addOverride("/gui/items.png", "/moCreatures/textures/sharkteeth.png")).setItemName("sharkteeth");
	public static Item sharkegg = (new ItemSharkEgg(3773)).setIconIndex(ModLoader.addOverride("/gui/items.png", "/moCreatures/textures/sharkegg.png")).setItemName("sharkegg");
