...
//            GuiScreen, ThreadConnectToServer, ModLoader, GameSettings, 
//            ModSettings, NetClientHandler, StringTranslate, GuiButton, 
//            GuiMainMenu
...
public class GuiConnecting extends GuiScreen
{
    ...
    public GuiConnecting(Minecraft minecraft, String s, int i)
    {
        ...
        ModSettings.setContext((new StringBuilder("MP")).append(ModLoader.getMinecraftInstance().gameSettings.lastServer.toLowerCase()).toString(), (new StringBuilder("mods/per_server/MP")).append(ModLoader.getMinecraftInstance().gameSettings.lastServer.toLowerCase()).append("/").toString());
    }
