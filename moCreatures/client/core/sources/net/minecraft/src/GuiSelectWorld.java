...
//            GuiCreateWorld, GuiRenameWorld, PlayerControllerSP, World, 
//            WorldInfo, ModSettings
...
public class GuiSelectWorld extends GuiScreen
{
    ...
    public void selectWorld(int i)
    {
        ...
        mc.displayGuiScreen(null);
        ModSettings.setContext((new StringBuilder("SP")).append(mc.theWorld.worldInfo.getWorldName()).toString(), (new StringBuilder("saves/")).append(mc.theWorld.worldInfo.getWorldName()).append("/mods/").toString());
    }
