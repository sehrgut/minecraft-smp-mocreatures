...
//            GuiAchievements, GuiStats, ModSettings, ModSettingScreen, 
//            WidgetSetting, GuiModSelect, GuiModScreen, MathHelper
...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        controlList.add(new GuiButton(15, width / 2 - 100, height / 4 + byte0 + 144, "World Mod Options"));
    }
