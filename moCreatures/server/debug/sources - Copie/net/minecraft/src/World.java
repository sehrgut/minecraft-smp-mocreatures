    ...
    implements IBlockAccess
{
    ...
    public World(ISaveHandler isavehandler, String s, long l, WorldProvider worldprovider)
    {
        ...
        if(flag)
        {
            ...
            savePath.setSpawnPosition(i, byte0, j);
            field_9209_x = false;
        }
    ...
    public Vec3D getAnaglyphs(Entity entity, float f)
    {
        float f1 = getCelestialAngle(f);
        ...
        float f3 = (float)getWorldChunkManager().getAnaglyphsCoords(i, j);
        getWorldChunkManager().func_4067_a(i, j);
        int k = getSkyColorByTemp(f3);
    ...
    public void func_21116_a(boolean flag, boolean flag1)
    {
        ...
        field_21120_L = flag1;
    	difficultySetting = mod_mocreatures.worldDifficulty;
    }
