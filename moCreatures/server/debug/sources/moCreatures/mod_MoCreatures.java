...
import moCreatures.entities.EntitySquid;
...
import modManager.tools.ExtendedPropertyManager;
...
public class mod_MoCreatures extends BaseMod
{
	...
	public static Item sharkTeeth = (new ItemProxy(3774)).setIconIndex(ModLoader.addOverride("/gui/items.png", "/mob/sharkteeth.png")).setItemName("sharkteeth");
	...
	public static ExtendedPropertyManager propertyManager = new ExtendedPropertyManager("moCreatures.properties", "");
