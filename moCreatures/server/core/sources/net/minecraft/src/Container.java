...
//            ICrafting, Slot, EntityPlayer, InventoryPlayer, 
//            ItemStack, StatList, IInventory
            ...
            } else
            {
                ...
                if(slot != null)
                {
                    ...
                    if(itemstack3 == null)
                    {
                        ...
                        {
                            entityplayer.addStat(StatList.field_25093_z[itemstack5.itemID], itemstack5.stackSize);
                        }
                    ...
                    if(itemstack2.itemID == itemstack3.itemID && itemstack3.getMaxStackSize() > 1 && (!itemstack2.getHasSubtypes() || itemstack2.getItemDamage() == itemstack3.getItemDamage()))
                    {
                        ...
                        if(j1 > 0 && j1 + itemstack3.stackSize <= itemstack3.getMaxStackSize())
                        {
                            ...
                            {
                                entityplayer.addStat(StatList.field_25093_z[itemstack6.itemID], itemstack6.stackSize);
                            }
                            if(itemstack2.stackSize == 0)
                            {
                                slot.putStack(null);
