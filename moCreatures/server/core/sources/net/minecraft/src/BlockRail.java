...
//            Block, World, Material, RailLogic, 
//            IBlockAccess, AxisAlignedBB, Vec3D, MovingObjectPosition
...
public class BlockRail extends Block
{
    ...
    public static final boolean func_27029_g(World world, int i, int j, int k)
    {
        ...
        return l == Block.minecartTrack.blockID || l == Block.railPowered.blockID || l == Block.railDetector.blockID;
    }

    public static final boolean func_27030_c(int i)
    {
        return i == Block.minecartTrack.blockID || i == Block.railPowered.blockID || i == Block.railDetector.blockID;
    }
