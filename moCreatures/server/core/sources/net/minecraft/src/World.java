...
//            ChunkCoordinates, Vec3D, IChunkProvider, SpawnerAnimals, 
//            EntityLightningBolt, EnumSkyBlock, WorldInfo, AxisAlignedBB, 
    ...
    implements IBlockAccess
{
    ...
    protected void doRandomUpdateTicks()
    {
        ...
        for(Iterator iterator = activeChunkSet.iterator(); iterator.hasNext();)
        {
            ...
            if(rand.nextInt(16) == 0 && func_27068_v())
            {
                distHashCounter = distHashCounter * 3 + DIST_HASH_MAGIC;
    ...
    private float field_27079_B;
    private float field_27078_C;
    private float field_27077_D;
    private float field_27076_E;
    private int field_27075_F;
