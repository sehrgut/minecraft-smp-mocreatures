...
//            ItemCloth, BlockLeaves, BlockRedstoneOre, Vec3D, 
//            BlockPressurePlate, ItemBlock, StepSound, BlockRedstoneTorch, 
//            BlockMobSpawner, StatCollector, BlockLadder, BlockCloth, 
//            BlockStone, ItemSlab, AxisAlignedBB, BlockPumpkin, 
//            BlockObsidian, World, BlockWorkbench, BlockGlass, 
//            BlockJukeBox, BlockSand, Item, ItemLog, 
//            BlockChest, EntityPlayer, BlockBookshelf, BlockSapling, 
//            EntityItem, ItemStack, StatList, BlockSnow, 
//            BlockFence, BlockLockedChest, BlockDoor, Material, 
//            BlockGlowStone, ItemSapling, BlockOre, BlockGravel, 
//            BlockCrops, BlockIce, BlockOreStorage, BlockStationary, 
//            BlockSoulSand, BlockButton, BlockFlowing, BlockCactus, 
//            BlockDirt, BlockRail, BlockDetectorRail, BlockNote, 
//            BlockSandStone, BlockReed, BlockWeb, EnumMobType, 
//            BlockClay, BlockRedstoneWire, BlockStairs, BlockFurnace, 
//            BlockMushroom, BlockSign, BlockCake, MovingObjectPosition, 
//            BlockBed, BlockLog, BlockFarmland, BlockTorch, 
//            BlockFlower, BlockRedstoneRepeater, BlockGrass, BlockSponge, 
//            BlockLever, BlockDispenser, IBlockAccess, BlockSnowBlock, 
//            BlockNetherrack, TileEntitySign, BlockFire, BlockStep, 
//            BlockTNT, StepSoundSand, StepSoundStone, BlockPortal, 
//            Entity, EntityLiving
...
public class Block
{
    ...
    static 
    {
        ...
        waterMoving = (new BlockFlowing(8, Material.water)).setHardness(100F).setLightOpacity(3).setBlockName("water").disableStats();
        waterStill = (new BlockStationary(9, Material.water)).setHardness(100F).setLightOpacity(3).setBlockName("water").disableStats();
        lavaMoving = (new BlockFlowing(10, Material.lava)).setHardness(0.0F).setLightValue(1.0F).setLightOpacity(255).setBlockName("lava").disableStats();
        lavaStill = (new BlockStationary(11, Material.lava)).setHardness(100F).setLightValue(1.0F).setLightOpacity(255).setBlockName("lava").disableStats();
        ...
        leaves = (BlockLeaves)(new BlockLeaves(18, 52)).setHardness(0.2F).setLightOpacity(1).setStepSound(soundGrassFootstep).setBlockName("leaves").disableStats();
        ...
        bed = (new BlockBed(26)).setHardness(0.2F).setBlockName("bed").disableStats();
        railPowered = (new BlockRail(27, 179, true)).setHardness(0.7F).setStepSound(soundMetalFootstep).setBlockName("goldenRail");
        railDetector = (new BlockDetectorRail(28, 195)).setHardness(0.7F).setStepSound(soundMetalFootstep).setBlockName("detectorRail");
        web = new BlockWeb(30, 11);
        ...
        redstoneWire = (new BlockRedstoneWire(55, 164)).setHardness(0.0F).setStepSound(soundPowderFootstep).setBlockName("redstoneDust").disableStats();
        ...
        crops = (new BlockCrops(59, 88)).setHardness(0.0F).setStepSound(soundGrassFootstep).setBlockName("crops").disableStats();
        ...
        signPost = (new BlockSign(63, net.minecraft.src.TileEntitySign.class, true)).setHardness(1.0F).setStepSound(soundWoodFootstep).setBlockName("sign").disableStats();
        doorWood = (new BlockDoor(64, Material.wood)).setHardness(3F).setStepSound(soundWoodFootstep).setBlockName("doorWood").disableStats();
        ladder = (new BlockLadder(65, 83)).setHardness(0.4F).setStepSound(soundWoodFootstep).setBlockName("ladder");
        minecartTrack = (new BlockRail(66, 128, false)).setHardness(0.7F).setStepSound(soundMetalFootstep).setBlockName("rail");
        stairCompactCobblestone = (new BlockStairs(67, cobblestone)).setBlockName("stairsStone");
        signWall = (new BlockSign(68, net.minecraft.src.TileEntitySign.class, false)).setHardness(1.0F).setStepSound(soundWoodFootstep).setBlockName("sign").disableStats();
        ...
        doorSteel = (new BlockDoor(71, Material.iron)).setHardness(5F).setStepSound(soundMetalFootstep).setBlockName("doorIron").disableStats();
        ...
        lightStone = (new BlockGlowStone(89, 105, Material.glass)).setHardness(0.3F).setStepSound(soundGlassFootstep).setLightValue(1.0F).setBlockName("lightgem");
        ...
        cake = (new BlockCake(92, 121)).setHardness(0.5F).setStepSound(soundClothFootstep).setBlockName("cake").disableStats();
        redstoneRepeaterIdle = (new BlockRedstoneRepeater(93, false)).setHardness(0.0F).setStepSound(soundWoodFootstep).setBlockName("diode").disableStats();
        redstoneRepeaterActive = (new BlockRedstoneRepeater(94, true)).setHardness(0.0F).setLightValue(0.625F).setStepSound(soundWoodFootstep).setBlockName("diode").disableStats();
