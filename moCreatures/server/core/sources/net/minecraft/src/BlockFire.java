...
//            Block, BlockLeaves, World, Material, 
//            IBlockAccess, BlockPortal, AxisAlignedBB
...
public class BlockFire extends Block
{
            ...
            for(int i1 = i - 1; i1 <= i + 1; i1++)
            {
                for(int j1 = k - 1; j1 <= k + 1; j1++)
                {
                    for(int k1 = j - 1; k1 <= j + 4; k1++)
                    {
                        ...
                        if(i2 > 0 && random.nextInt(l1) <= i2 && (!world.func_27068_v() || !world.func_27072_q(i1, k1, j1)) && !world.func_27072_q(i1 - 1, k1, k) && !world.func_27072_q(i1 + 1, k1, j1) && !world.func_27072_q(i1, k1, j1 - 1) && !world.func_27072_q(i1, k1, j1 + 1))
                        {
    ...
    private void tryToCatchBlockOnFire(World world, int i, int j, int k, int l, Random random)
    {
        ...
        if(random.nextInt(l) < i1)
        {
            ...
            if(random.nextInt(2) == 0 && !world.func_27072_q(i, j, k))
            {
