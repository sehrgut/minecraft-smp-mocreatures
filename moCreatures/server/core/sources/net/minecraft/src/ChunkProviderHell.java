...
//            WorldGenFlowers, IChunkProvider, MapGenBase, WorldGenGlowStone1, 
//            BlockSand, Chunk, MapGenCavesHell, WorldGenHellLava, 
//            WorldGenGlowStone2, NoiseGeneratorOctaves, Block, BlockFlower, 
//            WorldGenFire, World, IProgressUpdate
    ...
    implements IChunkProvider
{
    ...
    public void populate(IChunkProvider ichunkprovider, int i, int j)
    {
        ...
        for(int i1 = 0; i1 < 8; i1++)
        {
            ...
            (new WorldGenHellLava(Block.lavaMoving.blockID)).generate(field_4235_n, hellRNG, k1, i3, k4);
        }
        ...
        for(int i2 = 0; i2 < j1; i2++)
        {
            ...
            (new WorldGenGlowStone1()).generate(field_4235_n, hellRNG, k3, i5, j6);
        }
