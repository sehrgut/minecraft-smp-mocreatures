...
//            EntityAnimal, EntitySheep, AxisAlignedBB, World, 
//            Item, EntityPlayer, MathHelper, InventoryPlayer, 
//            ItemStack, EntityLiving, NBTTagCompound, EntityArrow, 
//            Entity, DataWatcher, ItemFood
...
public class EntityWolf extends EntityAnimal
{
    ...
    public void onLivingUpdate()
    {
        ...
        if(!field_9112_aN && isWet && !field_25042_g && !getGotPath() && onGround)
        {
            field_25042_g = true;
            field_25041_h = 0.0F;
            field_25040_i = 0.0F;
    ...
    public boolean attackEntityFrom(Entity entity, int i)
    {
        ...
        if(super.attackEntityFrom(entity, i))
        {
            ...
            {
                if(func_25030_y() && (entity instanceof EntityPlayer) && ((EntityPlayer)entity).username.equals(getOwner()))
                {
                    return true;
                }
                playerToAttack = entity;
