...
//            NetHandler, Packet7UseEntity, ChunkCoordinates, Container, 
//            AxisAlignedBB, Packet13PlayerLookMove, EntityPlayerMP, WorldServer, 
//            ChatAllowedCharacters, Slot, Packet15Place, ServerConfigurationManager, 
//            Packet16BlockItemSwitch, Packet103SetSlot, Packet10Flying, MathHelper, 
//            InventoryPlayer, ItemStack, Packet14BlockDig, Packet0KeepAlive, 
//            Packet18Animation, Packet106Transaction, Packet3Chat, NetworkManager, 
//            Packet27Position, Packet102WindowClick, Entity, ICommandListener, 
//            Packet19EntityAction, Packet53BlockChange, Packet130UpdateSign, TileEntitySign, 
//            ItemInWorldManager, Packet255KickDisconnect, Packet, Packet9Respawn, 
    ...
    implements ICommandListener
{
    ...
    public void handleFlying(Packet10Flying packet10flying)
    {
        ...
        if(hasMoved)
        {
            ...
            if(!mcServer.allowFlight && !mcServer.worldMngr.func_27069_b(axisalignedbb))
            {
                if(d12 >= -0.03125D)
                {
                    playerInAirTime++;
    ...
    public void handlePlace(Packet15Place packet15place)
    {
        ...
        } else
        {
            ...
            if(j1 > 16 || flag)
            {
                playerEntity.itemInWorldManager.activeBlockOrUseItem(playerEntity, mcServer.worldMngr, itemstack, i, j, k, l);
            }
            playerEntity.playerNetServerHandler.sendPacket(new Packet53BlockChange(i, j, k, mcServer.worldMngr));
            if(l == 0)
            {
    ...
    {
        Entity entity = mcServer.worldMngr.func_6158_a(packet7useentity.targetEntity);
    ...
    {
        if(mcServer.worldMngr.blockExists(packet130updatesign.xPosition, packet130updatesign.yPosition, packet130updatesign.zPosition))
        {
            TileEntity tileentity = mcServer.worldMngr.getBlockTileEntity(packet130updatesign.xPosition, packet130updatesign.yPosition, packet130updatesign.zPosition);
