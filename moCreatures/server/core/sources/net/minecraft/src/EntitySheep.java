...
//            EntityAnimal, World, EntityItem, ItemStack, 
//            EntityLiving, NBTTagCompound, DataWatcher, Block, 
//            Entity
...
public class EntitySheep extends EntityAnimal
{
    ...
    {
        if(!worldObj.singleplayerWorld && !func_21069_f_() && (entity instanceof EntityLiving))
        {
            setSheared(true);
