...
//            Item, EntityPlayer, StatList, NBTTagCompound, 
//            Block, World, Entity, EntityLiving
...
public final class ItemStack
{
    ...
    public boolean useItem(EntityPlayer entityplayer, World world, int i, int j, int k, int l)
    {
        ...
        if(flag)
        {
            entityplayer.addStat(StatList.field_25107_A[itemID], 1);
        }
        return flag;
    }
    ...
    public void func_25125_a(int i, Entity entity)
    {
        ...
        if(itemDamage > getMaxDamage())
        {
            ...
            {
                ((EntityPlayer)entity).addStat(StatList.field_25105_B[itemID], 1);
            }
            stackSize--;
            if(stackSize < 0)
            {
