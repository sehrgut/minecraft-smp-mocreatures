...
//            EntityLiving, ChunkCoordinates, EntityGhast, IChunkProvider, 
//            EnumStatus, Container, AxisAlignedBB, AchievementList, 
//            World, EntityBoat, EntityCreeper, EntityWolf, 
//            Item, EntityMob, EntityItem, MathHelper, 
//            InventoryPlayer, ItemStack, StatList, Material, 
//            NBTTagCompound, EntityArrow, Entity, NBTTagList, 
//            DataWatcher, Block, BlockBed, EntityPig, 
//            ContainerPlayer, WorldProvider, EntityMinecart, EntityFish, 
...
public abstract class EntityPlayer extends EntityLiving
{
        ...
        if(ridingEntity != null)
        {
            ...
            if(i > 0)
            {
                if(ridingEntity instanceof EntityMinecart)
                {
                    ...
                    if(field_9155_d == null)
                    {
                        field_9155_d = new ChunkCoordinates(MathHelper.floor_double(posX), MathHelper.floor_double(posY), MathHelper.floor_double(posZ));
                    } else
                    if(field_9155_d.getSqDistanceTo(MathHelper.floor_double(posX), MathHelper.floor_double(posY), MathHelper.floor_double(posZ)) >= 1000D)
                    {
    ...
    private ChunkCoordinates field_9155_d;
