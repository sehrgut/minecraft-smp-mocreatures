...
//            SpawnListEntry, ChunkCoordinates, EntitySpider, PathEntity, 
//            EntitySheep, PathPoint, World, EntitySkeleton, 
//            Pathfinder, EntityPlayer, MathHelper, BiomeGenBase, 
//            EnumCreatureType, Material, EntityLiving, EntityZombie, 
//            BlockBed, ChunkPosition, WorldChunkManager, ChunkCoordIntPair
                ...
                if((!var38.func_21103_d() || var2) && (var38.func_21103_d() || var1) && var0.countEntities(var38.getCreatureClass()) <= var38.getMaxNumberOfCreature() * eligibleChunksForSpawning.size() / 256)
                {
                    ...
                    while(var39.hasNext())
                    {
                        ...
                        if(var12 != null && !var12.isEmpty())
                        {
                            ...
                            int var18 = var41.y;
                            int var19 = var41.z;
                            if(!var0.isBlockOpaqueCube(var42, var18, var19) && var0.getBlockMaterial(var42, var18, var19) == var38.getCreatureMaterial())
                            {
                                int var20 = 0;
